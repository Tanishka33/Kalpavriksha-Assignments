...
int findTeamIndexByName(const char *name, const Team teamsArr[])
{
    int result = -1;
    if (name && teamsArr)
    {
...
int displayTeamPlayers(const Team teamsArr[])
{
    int teamIdInput = 0;
    int status = 0;
...
int displayTopK(const Team teamsArr[])
{
    int status = 0;
    int teamIdInput = 0;
    int teamIndex = 0;
...
int displayRoleOfTeam(const Team teamsArr[])
{
    int status = 0;
    int roleChoice = 0;
    int roleIndex = -1;
